                    ...
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD" readonly
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3"   value="{{ $invoices->note }}" readonly></textarea>
                            </div>
                        </div><br>
